opendir my $dir, "/Users/buchanan/OneDrive - Missouri State University/RESEARCH/2 projects/QWERTY/9 15 stuff/exp analyses/raw data 2/" or die "Cannot open directory: $!";
...
open(FIN,"/Users/buchanan/OneDrive - Missouri State University/RESEARCH/2 projects/QWERTY/9 15 stuff/exp analyses/raw data 2/$files[$i]") or die "could not open file";
while(<FIN>) {
next if /#/;
chomp; tr/ \t/ /s;
next if /^date/;
...
if ($trialcode eq "whichhand") { $hand = $response; }
    ...
    print $date, " ", $time, " ", $subject, " ", $response, " ", $hand, " ", $speed, " ", $error, " ", $trialcode, "\n";
    }
